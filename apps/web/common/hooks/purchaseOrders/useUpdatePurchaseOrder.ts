...
import { T_Purchase_Orders, T_Update_Purchase_Orders } from "./types"

export async function updatePurchaseOrder(id: string, data: T_Update_Purchase_Orders) {
...
function useUpdatePurchaseOrder(id: string) {
  const query = useMutation({
    mutationFn: (data: T_Update_Purchase_Orders) => updatePurchaseOrder(id, data),
  })
  return query
}
