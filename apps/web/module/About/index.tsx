    ...
    <div className="lg:mx-auto flex-grow mb-auto items-center justify-between">
      ...
      <div className='grid mb-auto bg-slate-900 w-full lg:h-[50rem] h-auto justify-center items-center'>
        ...
        <div className='grid  -gap-x-20 lg:grid-cols-2 sm:grid-cols-1 bg-slate-900 w-full lg:h-[40rem] h-auto justify-center'>
          ...
          <h1 className="lg:size-[33rem] lg:ml-32 mt-20 text-white lg:text-[6rem] md:text-[35px] md:ml-5 sm:text-[25px] font-bold font-sans leading-[6rem] sm:ml-10">The #42
            and the bot</h1>
          <p className="lg:size-[33rem] lg:ml-36 text-white lg:text-[2rem] md:text-[35px] md:ml-5 sm:text-[25px] font-bold font-sans sm:ml-10 lg:-mt-[21rem]">Because #21 is only half the story!</p>
          </div>  
          <div className="m-10 ml-40 text-white text-[5rem]">
          <Image
              src="/about_image.jpg"
              alt="Your Company"
              width={350}
      ...
      <div className="mt-16 grid lg:grid-cols-3 grid-cols-1 justify-center text-justify gap-10 gap-x-16">
        <div>
          <h1 className="text-[#dc0bb4] text-lg font-extrabold">WHAT IS A BOT?</h1>
...
A company or individual can use a bot to replace and facilitate a repetitive task that would otherwise have to be performed by a human. Bots are also much faster at these tasks than humans. Although bots can perform useful functions, they can also be malicious and come in the form of malware bots.</p>
      ...
      <div className="text-justify">
          <h1 className="text-[#dc0bb4] font-extrabold pt-16 text-lg">DEFINITION OF AI?</h1>
