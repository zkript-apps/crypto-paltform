        ...
        <div className="grid mb-auto bg-black w-full lg:h-[50rem] h-auto justify-center items-center">
          <div className="grid  -gap-x-20 sm:pb-10 lg:grid-cols-2 sm:grid-cols-1 bg-black w-full lg:h-[40rem] h-auto justify-center">
            <div className="flex-col">
              <h1 className="lg:size-[33rem] lg:ml-32 text-white lg:text-[6rem] md:text-[35px] md:ml-5 sm:text-[25px] font-bold font-sans leading-[7rem] sm:ml-10">
                The #42 and the bot
              </h1>
              <p className="lg:size-[33rem] lg:ml-[8rem] text-white lg:text-[2rem] md:text-[35px] md:ml-5 sm:text-[25px] font-bold font-sans sm:ml-10 lg:-mt-[19rem]">
                Because #21 is only half the story!
              </p>
            </div>
            <div className="mx-10 ml-40 text-white text-[5rem]">
              ...
              >
                <div className="flex items-center justify-between">
                  <div>YOU CAN BUY TOKENS HERE</div>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="lg:flex w-auto grid-cols-1 lg:m-0 h-auto justify-center mx-auto">
            <div className="border-primary-500 border lg:h-auto lg:w-[39rem] lg:mb-[16rem] lg:ml-24 lg:-mt-[20rem] lg:mx-0 mx-[4rem] bg-white flex items-center">
              ...
              <div className="lg:ml-16 lg:py-[0.5rem] my-[5rem] lg:mr-40 text-justify lg:w-[25rem] lg:mx-10 mx-5 h-auto">
                <h1 className="font-bold lg:text-[3rem] text-[1.5rem] h-auto">
                  Lorem Ipsum
                </h1>
              ...
              <div className="mt-16 grid lg:grid-cols-3 grid-cols-1 justify-center text-justify gap-10 gap-x-16">
                <div>
                  ...
                  <p className="text-white font-sans text-md leading-6 font-normal mt-5">
                    The word bot is derived from the English term robot . Bots
                    are computer programs that work for a user or another
                    program or simulate a human activity. Bots are typically
                    used to automate certain tasks, meaning they can be
                    performed without specific instructions from humans. A
                    company or individual can use a bot to replace and
                    facilitate a repetitive task that would otherwise have to be
                    performed by a human. Bots are also much faster at these
                    tasks than humans. Although bots can perform useful
                    functions, they can also be malicious and come in the form
                    of malware bots.
                  </p>
                </div>
                <div>
