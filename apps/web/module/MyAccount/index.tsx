  ...
  return (
    <>
      ...
      <div className="lg:mx-auto mb-auto items-center justify-between">
        ...
        <div className="grid bg-dark-950 w-full lg:h-auto  h-auto justify-center items-center text-center pb-20">
        <div className="lg:mx-0 mx-10">
          ...
          <div className="bg-white flex-col w-full lg:w-[100rem] font-semibold h-auto py-10 rounded-2xl mt-5 border-primary-500 border text-start flex">
            <div className="mx-10">
              ...
              volutpat nisl. Proin nec viverra quam. Proin sollicitudin, erat nec porta suscipit, neque nisl
               ...
               cubilia curae. Quelle: <span className="text-primary-500">www.statista.com</span></p>
